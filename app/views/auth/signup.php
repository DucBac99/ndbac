...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid p-0"> 
            <div class="row m-0">
            <div class="col-xl-5"><img class="bg-img-cover bg-center" src="../assets/images/bg-signup.png" alt="looginpage"></div>
            <div class="col-xl-7 p-0"> 
                <div class="login-card">
                <form action="<?= APPURL . "/signup" ?>" method="POST" class="theme-form login-form">
                    ...
                    <h6>Nhập vào thông tin của bạn để tạo tài khoản</h6>
                    </div>
                    ...
                    <h5>Đăng ký với Email</h5>
                    </div>
                    <div class="form-group">
                    <label>Họ và tên</label>
                    <div class="small-group">
                        <div class="input-group"><span class="input-group-text"><i class="icon-user"></i></span>
                        <input class="form-control" type="text" id="firstname" name="firstname" placeholder="Nhập họ của bạn">
                        </div>
                        <div class="input-group"><span class="input-group-text"><i class="icon-user"></i></span>
                        <input class="form-control" type="text" id="lastname" name="lastname" placeholder="Nhập tên của bạn" required>
                        </div>
                    </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="checkbox">
                        ...
                        <label class="text-muted" for="checkbox1">Đồng ý với <span>Điều khoản và Chính sách của chúng tôi                  </span></label>
                    </div>
                    </div>
                    <div class="form-group">
                    <button class="btn btn-primary btn-block" type="submit">Đăng ký</button>
                    </div>
                    <p>Bạn đã có tài khoản?<a class="ms-2" href="<?= APPURL . "/login" ?>">Đăng nhập</a></p>
                </form>
                </div>
            </div>
            </div>
