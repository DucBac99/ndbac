...
<html lang="en" class="light-style layout-navbar-fixed layout-menu-fixed layout-compact" dir="ltr" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
    ...
    <meta
        ...
        <title>Nạp tiền | <?= site_settings("site_name") . " - " . site_settings("site_slogan") ?></title>
    ...
    <div class="layout-wrapper layout-content-navbar">
        ...
        <div class="layout-page">
            ...
            <?php require_once(APPPATH . '/views/profile/fragments/topup.fragment.php'); ?>
            <!-- / Content -->
    ...
    <script type="text/javascript">
        $(function() {
            $("body").on("change keyup", "#money", function() {
                var url = `https://img.vietqr.io/image/<?= $AuthSite->get("banking.auth.bank_code") ?>-<?= $AuthSite->get("banking.info.account_number") ?>-<?= $AuthSite->get("banking.auth.template") ?>.png?amount=${this.value}&accountName=<?= $AuthSite->get("banking.info.account_name") ?>&addInfo=<?= $AuthSite->get("banking.info.content") . " " . $AuthUser->get("id") ?>`;
