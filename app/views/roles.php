    ...
    >
        ...
        <script type="text/javascript">
            ...
            table_data = $table.on("preXhr.dt", function(t, a, e) {
                ...
                data: "color",
                render: function(t, a, e) {
                    return `<span class="badge badge-outline-${t}">${t}</span>`
                },
                }, {
                data: "amount",
                render: function(t, a, e) {
                ...
                render: function(t, a, e) {
                    return `<div class="relative flex w-full items-center px-5 py-2.5 dark:bg-[#0e1726]">
                                ...
                                <div class="remove">
                                    <button class="block rounded-full bg-white-light/40 p-2 hover:bg-white-light/90 hover:text-primary dark:bg-dark/40 dark:hover:bg-dark/60 js-remove-item" data-table="#roles_table" data-url="${$table.data("url")}" data-id="${t}" data-bs-popup="tooltip" title="Xoá">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
