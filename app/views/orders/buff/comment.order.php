                ...
                <div class="card-body">
                    <form class="js-ajax-form" action="<?= APPURL . "/orders/" . $Service->get("group") . "/" . $Service->get("idname") . "/new" ?>" method="POST" novalidate>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    <label class="fw-bold form-label">Danh sách bình luận <span id="count_comment_need">( 0 )</span></label>
                                    <textarea type="text" name="comment_need" class="form-control input-count" data-target="#count_comment_need" placeholder="Nhập nội dung bình luận, mỗi bình luận 1 dòng" rows="5" required></textarea>
                                    <div class="form-text">Số nội dung phải lớn hơn hoặc bằng số lượng mua</div>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="mb-3">
