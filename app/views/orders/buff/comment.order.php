            ...
            <div class="mb-5">
                ...
                <input type="hidden" name="idname" value="<?= $Service->get("idname") ?>">
                    <div class="grid grid-cols-1 gap-4 sm:col-span-2">
                        ...
                        <div class="mb-3">
                            <label for="spiRight">Danh sách bình luận <span id="count_comment_need">( 0 )</span></label>
                            <textarea id="ctnTextarea" type="text" name="comment_need" data-target="#count_comment_need" rows="5" class="form-textarea input-count" required placeholder="Nhập nội dung bình luận, mỗi bình luận 1 dòng"></textarea>
                        </div>
