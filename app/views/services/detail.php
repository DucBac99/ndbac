...
<html lang="en" class="light-style layout-navbar-fixed layout-menu-fixed layout-compact" dir="ltr" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
    <head>
        ...
        <meta
            ...
            <title> <?= $Service->isAvailable() ? htmlchars($Service->get("title") . " " . $Service->get("group")) : "Dịch vụ mới" ?></title>
    ...
    <body>
        ...
        <div class="layout-wrapper layout-content-navbar">
            ...
            <div class="layout-page">
                ...
                <?php if (isset($page) && $page == "pricing") {
                        require_once(APPPATH . '/views/services/fragments/service-pricing.fragment.php');
                    } else {
                        require_once(APPPATH . '/views/services/fragments/service.fragment.php');
                    }
                ?>
                <!-- / Content -->
        ...
        <script src="<?= APPURL . "/assets/ckeditor/ckeditor.js?v=" . VERSION ?>"></script>
        ...
        <script src="<?= APPURL . "/assets/js/pages/service.js?v=" . VERSION ?>"></script>
        ...
        <script>
            ...
            <?php if (isset($page) && $page == "pricing") : ?>
                get_list_price_by_domain();

                $(".select").on("change", function(e) {
                get_list_price_by_domain();
                });
            <?php elseif (isset($Service) && $Service->isAvailable()) : ?>
                get_list_server_by_domain();
