        ...
        <div class="space-y-6">
            <div class="panel items-center p-2">
                <div class="flex items-center">
                    <span class="ltr:mr-3 rtl:ml-3 w-full">Danh sách Dịch vụ</span>
                    <div class="ml-auto flex space-x-2">
                    <a type="button" class="btn btn-success text-white p-2" href="<?= APPURL . "/services/new" ?>">
                    ...
                    <a type="button"  @click="showAlert()" class="btn btn-danger text-white p-2 js-remove-list-item" href="javascript:void(0)" data-url="<?= APPURL . "/services" ?>" data-table="#services_table">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="panel">
                    <div class="card-body">
                        <table class="table table-bordered table-striped" id="services_table" data-url="<?= APPURL . "/services" ?>">
                            <thead>
                                <tr>
                                    <th>
