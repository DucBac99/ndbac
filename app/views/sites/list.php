...
<html lang="en" dir="ltr">
    <head>
        ...
        <title>Sites | <?= site_settings("site_name") . " - " . site_settings("site_slogan") ?></title>
    ...
    >
        ...
        <div class="main-container min-h-screen text-black dark:text-white-dark" :class="[$store.app.navbar]">
            ...
            <div class="main-content flex flex-col min-h-screen">
                ...
                <?php require_once(APPPATH . '/views/sites/fragments/sites.fragment.php') ?>

                <!-- start footer section -->
                <?php require_once(APPPATH . '/views/components/fragments/footer.component.php') ?>
                <!-- end footer section -->
            </div>
        </div>
