...
<html lang="en" class="light-style layout-navbar-fixed layout-menu-fixed layout-compact" dir="ltr" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
    <head>
        ...
        <meta
            ...
            <title>Giao diện | <?= site_settings("site_name") . " - " . site_settings("site_slogan") ?></title>
    ...
    <body>
        ...
        <div class="layout-wrapper layout-content-navbar">
            ...
            <div class="layout-page">
                ...
                <?php require_once(APPPATH . '/views/admin/fragments/themes.fragment.php'); ?>
                <!-- / Content -->
        ...
        <script type="text/javascript">
            $(function() {
                ...
                table_data = $table.on("preXhr.dt", function(t, a, e) {
                    ...
                    $("#themes_table_filter input").unbind(), $("#themes_table_filter input").bind("keyup", function(a) {
