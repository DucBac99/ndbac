...
<html lang="en" class="light-style layout-navbar-fixed layout-menu-fixed layout-compact" dir="ltr" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
    <head>
        ...
        <meta
            ...
            <title>Hiệu ứng | <?= site_settings("site_name") . " - " . site_settings("site_slogan") ?></title>
    ...
    <body>
        ...
        <div class="layout-wrapper layout-content-navbar">
            ...
            <div class="layout-page">
                ...
                <?php require_once(APPPATH . '/views/admin/fragments/effects.fragment.php');?>
                <!-- / Content -->
        ...
        <script>
            $(function() {
                $('.form-select').on('change', function(e) {
                    $option = $('.form-select option:selected');
                    $("#card_thumb").html(`<div class="card mb-3">
                            <a href="${$option.data("thumb")}" class="image-popup" data-bs-popup="lightbox">
                                <img src="${$option.data("thumb")}" class="img-fluid" alt="work-thumbnail" >
                            </a>
                            </div>`);
                    Sub99.initGLightbox();
                });
