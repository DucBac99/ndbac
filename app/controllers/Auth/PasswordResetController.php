    ...
    private function resetpass()
    {
        ...
        if ($password && $password_confirm) {
            if (mb_strlen($password) < 6) {
                $this->setVariable("error", "Mật khẩu phải dài ít nhất 6 ký tự!");
            } else if ($password_confirm != $password) {
                $this->setVariable("error", "Xác nhận mật khẩu không khớp!");
            } else {
            ...
            $this->setVariable("error", "Tất cả các trường là bắt buộc!");
        }
